...
var ErrorRetrieveSIDRecord = errors.New("failed to retrieve SID record from blockchain")
var ErrorRetrieveSACRecord = errors.New("Error while retrieving sac record from the blockchain")
...
var ErrorSACSignatureVerification = errors.New("the provided signature is not valid for the given SAC")
var ErrorPACNotValid = errors.New("the provided PAC is expired or not valid for the given PID")
var ErrorSACMismatch = errors.New("the provided SAC and the one retrieved from the blockchain doesn't match for this public key ")
